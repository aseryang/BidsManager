...
void QNavigationWidget::paintEvent(QPaintEvent *)
{
    ...
    for(int i = 0; i < listItems.size(); ++i)
    {
        ...
        painter.drawText(QRect(0, count * rowHeight, width(), rowHeight), Qt::AlignVCenter | Qt::AlignHCenter, listItems.at(i));
...
void QNavigationWidget::setCurrentIndex(int index)
{
	currentIndex = index;
	update();
}
